...
var ntc = {
  init(formatName) {
    ...
    ntc.shouldFormatName = formatName;
  ...
  name(color) {
    ...
    for (var i = 0; i < ntc.names.length; i++) {
      if (color == "#" + ntc.names[i][0])
        return ["#" + ntc.names[i][0], (ntc.shouldFormatName?ntc.formatName:(a)=>a)(ntc.names[i][1]), true];
    ...
    return cl < 0
      ...
      : ["#" + ntc.names[cl][0], (ntc.shouldFormatName?ntc.formatName:(a)=>a)(ntc.names[cl][1]), false];
  },
